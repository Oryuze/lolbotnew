...
async function start() {
    ...
    // Get Profile Picture Group
       ...
       ppgc = 'https://telegra.ph/file/a57060e0451dd296bf97f.jpg'
       }
...
let Tod = `Selamat Datang DI GRUP *${metadata.subject}*\n\nUsername : @${num.split("@")[0]} \n\nSilahkan Intro-!\nTag admin untuk melihat list intro atau ketuk button intro dibawah`
                ...
                client.relayMessage(anu.id, template.message, { messageId: template.key.id })
     ...
     * @returns
     */
    client.send5ButImg = async (jid , text = 'Hallo' , footer = '', img, but = [], options = {}) =>{
